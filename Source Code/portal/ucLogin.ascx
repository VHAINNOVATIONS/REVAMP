    ...
    <ContentTemplate>
        <div runat="server" id="divLogin">
            <asp:Panel BorderStyle="None" DefaultButton="btnLogin" ID="Panel1" runat="server">
                ...
                <asp:TextBox ID="txtU" EnableViewState="true" runat="server" Width="98%"></asp:TextBox><br />
                <asp:Label ID="lblPassword" CssClass="lbl-login" Text="password" AssociatedControlID="txtP" runat="server"></asp:Label><br />
                <asp:TextBox ID="txtP" EnableViewState="true" runat="server" TextMode="Password" Width="98%"></asp:TextBox><br />
                <br />
                <div style="text-align:right;">
                    <asp:Button ID="btnLogin" CssClass="button-yellow" runat="server" Text="Login" OnClick="btnLogin_Click" UseSubmitBehavior="false" /><br />
                    <a href="reset_password.aspx" style="display:block; color: blue; text-decoration:underline; margin-top:10px; font-size:.8em;">Reset Password</a>
                </div>
            </asp:Panel>
        ...
        <div runat="server" id="divChangePassword">
            ...
            <br />
            <asp:Button ID="txtNew" CssClass="button-yellow" runat="server" Text="Change Password" OnClick="btnLogin_Click" UseSubmitBehavior="false" />
        </div>
