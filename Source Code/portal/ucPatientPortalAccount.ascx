...
<link rel="StyleSheet" href="css/websuat.css" type="text/css" />
                ...
                <tr>
                    <td colspan="2">
                        <div id="divResetPWDButton" style="text-align: center;" runat="server">
                            ...
                            <%--
                    <asp:Button ID="btnResetPassword" CssClass="button" CssClass="button" runat="server" Text="Reset Password" OnClick="btnResetPassword_click">
                    </asp:Button>
                    --%>
                        </div>
                    </td>
