...
public class CUserAdmin
{
    ...
    public bool UpdateGraphPref(BaseMaster BaseMstr,
                                int iOption)
    {
        //status info
        long lStatusCode = -1;
        ...
        //add params for the DB stored procedure call
        plist.AddInputParameter("pi_nGraphOpt", iOption);

        BaseMstr.DBConn.ExecuteOracleSP("PCK_USER_ADMIN.UpdateGraphPref",
                                          plist,
                                          out lStatusCode,
                                          out strStatusComment);
        ...
        if (lStatusCode == 0)
        {
            BaseMstr.GraphicOption = iOption;
            return true;
        }
