...
public class CSec
{
    ...
    public bool InsertFXUser( BaseMaster BaseMstr,
                              ...
                              out long lUserID)
    {
        ...
        BaseMstr.DBConn.ExecuteOracleSP("PCK_FX_SEC.InsertFXUser",
                                          plist,
                                          out lStatusCode,
                                          out strStatusComment);
        ...
        if (lStatusCode == 0)
        {
            //BaseMstr.StatusComment = "SUAT User - Saved. ";
            //set the out param
    ...
    public bool UpdateFXUserPWD( BaseMaster BaseMstr,
                              long lFXUserID,
                              string strUserName,
                              string strPassword,
                              bool bAccountLocked,
                              bool bAccountInactive)
    {
        ...
        BaseMstr.DBConn.ExecuteOracleSP("PCK_FX_SEC.UpdateFXUserPWD",
                                          plist,
                                          out lStatusCode,
                                          out strStatusComment);
