...
public partial class ucMessagesRead : System.Web.UI.UserControl
{
    ...
    protected string GetRecipientsList() {
        ...
        CheckBoxList[] chklist = {chklstPatients, chklstProviders };
    ...
    protected void LoadPatientsList() {
        DataSet dsPats = msg.GetProviderPatientsDS();
        chklstPatients.DataSource = dsPats;
        chklstPatients.DataTextField = "PATIENT_NAME";
        chklstPatients.DataValueField = "FX_USER_ID";
        chklstPatients.DataBind();
