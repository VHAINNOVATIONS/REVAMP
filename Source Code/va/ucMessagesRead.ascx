...
<asp:UpdatePanel ID="upWrapper" runat="server" ChildrenAsTriggers="true">
    <ContentTemplate>
        <asp:UpdatePanel ID="upMesaggesView" runat="server" ChildrenAsTriggers="true">
            <ContentTemplate>
                <div id="divMessagesWrapper" style="width: 99%">
            ...
            <Content>
                <div style="padding: 10px;">
                    <div style="margin: 5px 0; padding: 4px; background-color: #eae4e4;">
                        ...
                        <input type="button" id="btnCancelMsg" value="Cancel" onclick="messages.cancelCompose();" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                    <table border="0" style="width: 100%;">
        ...
        <ext:Window ID="winSelectPatient" runat="server" Title="Select Patient" Icon="EmailAdd"
            ...
            <Content>
                ...
                <div style="margin:10px 0; text-align:center;">
                    <input type="button" value="Select" onclick="Ext.onReady(function () { winSelectPatient.hide(); });" />
                </div>
            </Content>
        </ext:Window>
    </ContentTemplate>
